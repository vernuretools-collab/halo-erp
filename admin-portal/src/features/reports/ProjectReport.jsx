...
import { getProjectMetrics } from './services/reportService'
import { BarChart3, DollarSign, Layers, CheckCircle2, Clock, Loader2 } from 'lucide-react'

export const ProjectReport = () => {
  const { projects, setProjectMetrics, isLoading, setIsLoading } = useReportStore()
  ...
  useEffect(() => {
    ...
    fetchMetrics()
  }, [setProjectMetrics, setIsLoading])
