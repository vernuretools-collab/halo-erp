    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        {customRoles.map((role) => (
          <Card key={role.roleId} hover className="space-y-4 border-border bg-surface">
                  ...
                  <label
                    ...
                    className={`flex items-center gap-2 p-2.5 rounded-xl border text-xs cursor-pointer transition-colors ${
                      isChecked
                        ...
                        : 'bg-slate-100/70 dark:bg-slate-900/60 border-border text-slate-600 dark:text-muted hover:text-slate-900 dark:hover:text-slate-300'
                    }`}
                  >
                    <input
                      type="checkbox"
                      ...
                      className="rounded bg-canvas border-border text-accent focus:ring-accent"
                    />
